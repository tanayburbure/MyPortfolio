...
const Client = () => {
  return (
    <div className="relative w-full mt-20 overflow-hidden">
      ...
      <div className="absolute left-0 mt-[20vh] lg:mt-[52.5vh] w-full h-full z-0">
        <Earth />
      </div>
      ...
      <div className="relative z-10 pt-32 lg:pt-56 px-6 lg:pl-[31vh] flex flex-col justify-center">
        ...
        <AnimatedText className="text-4xl lg:text-[9vh] cursor-expand mb-12 lg:mb-20 tracking-tight w-full lg:w-[80%] font-semibold leading-[10.5vw] lg:leading-[4.1vw]">
