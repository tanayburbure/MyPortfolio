...
function Motto() {
  return (
    <div className="h-[100vh]  relative overflow-hidden">
      ...
      {/* Top smoky gradient */}
      <div className="absolute top-0 left-0 w-full h-[20vh] bg-gradient-to-t from-[#0D0D0D] to-transparent z-0" />

      {/* Bottom smoky gradient */}
      <div className="absolute bottom-0 left-0 w-full h-[20vh] bg-gradient-to-b from-[#0D0D0D] to-transparent z-0" />
