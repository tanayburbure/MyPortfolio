        ...
        <div className="relative">
            ...
            >
                <div className="inline-block pl-[15%] relative">
                    ...
                    <p className="text-[#2F2D29] pb-[1vh] pt-[-1vh] font-medium text-[8.2vw] leading-[6.5vw]">
                        {project.title}
                    </p>
                    
                    <motion.p
                        style={{ clipPath: clipPathStyle }}
                        className="absolute top-0 left-[14.85vw] text-[#b7ab98] pb-1 font-medium text-[8.2vw] leading-[6.5vw]"
                    >
                        {project.title}
                    </motion.p>
                </div>
...
function Descriptions({ projects, selectedProject }) {
    return (
        <div className="absolute top-[0.8vh] w-screen z-2 pointer-events-none b-[0.9vh]">
            {projects.map((project, index) => (
                <div
                    key={index}
