...
const projects = [
    ...
    { title: "VISHUAL", description: "Visual concept and design language for the Lincoln Zephyr 2022.", speed: 0.67 },
    { title: "MOTION", description: "Part of a massive team that created a Royal Caribbean eco-system.", speed: 0.8 },
    ...
    return (
        <div className="absolute top-0 h-full w-full z-2 pointer-events-none">
            {projects.map((project, index) => (
                <div
                    key={index}
                    className="bg-[#ec4e39] pb-[0.4vh] text-[#0D0D0D] font-medium flex justify-between items-center px-[15%] transition-all duration-500 ease-in-out"
                    style={{
