    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative h-full z-10 flex flex-col items-center justify-center">
        ...
        <div className="overflow-hidden">
          <h2
            ref={h2Ref}
            className="font-light pr-2 tracking-tighter text-[10.2vh] text-center sm:text-[12vh] md:text-[14vh] lg:text-[17vh] text-[#EC4E39] font-[font13] cursor-expand w-full sm:w-[100%] md:w-[70%] lg:w-[60%] leading-[9.4vh] sm:leading-[8vw] md:leading-[7.5vw] lg:leading-[7.2vw]"
          >
