  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full absolute top-[28%]">
          ...
          <h1 className="text-center text-[16vh] font-bold leading-[6.4vw] tracking-tighter cursor-expand font-[font6]">
            STILL&nbsp;
            <span className="text-[#EB5939]">DEBUGGING <br /></span>
          </h1>
          <h3 className='text-center text-[7vh] font-semibold cursor-expand'>SINCE 2023</h3>
      </div>
    </div>
  );
}
