  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className='h-screen pl-[5vw] md:pl-[15vh] lg:pl-[31vh] flex flex-col justify-center mt-8 lg:mt-4'>
        ...
        <AnimatedText className="text-[5vh] sm:text-[6vh] md:text-[7vh] lg:text-[8.5vh] font-[font9] tracking-tight sm:tracking-normal w-[97%] sm:w-[85%] md:w-[80%] lg:w-[80%] font-semibold leading-[9vw] sm:leading-[7vw] md:leading-[10vh] lg:leading-[3.8vw] cursor-expand">
