  ...
  return (
    <div className="h-[50vh] flex flex-col w-full ">
      <div className="pl-[32vh] pt-[15vh] px-48">
        ...
        <div className="grid grid-cols-3 no-mask font-[font8]">
          <ul className="text-[3.5vh]">
          ...
          <ul className="text-[3.5vh]">
            ...
            <li className="flex items-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="tracking-tight mr-[16vh]"
              >
                Linkedin
              </a>
              </HoverAnimation>
          ...
          <ul className="pt-1">
            <li className="pb-3 flex items-center text-[2.7vh]">
            ...
            <li className="flex items-center text-[2.5vh]">
      ...
      <h3 className="text-center tracking-normal font-semibold text-md pt-2 text-[#B7AB98] font-[font14]">Design inspired by &nbsp; <span className="text-[#EB5939]">M I N H  &nbsp; P H A M</span></h3>
    </div>
  );
}
