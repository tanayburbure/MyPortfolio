  ...
  return (
    <div className='h-screen pl-[31vh] pb-4 flex flex-col justify-center'>
      ...
      <AnimatedText className="text-[9vh] tracking-tighter w-[77%] font-semibold leading-[4.5vw] cursor-expand">
        I'm a <span className='text-[#EB5939] font-[font14] tracking-wider'>visually skilled</span> interactive web designer and developer with a strong focus on crafting high-quality, impactful digital experiences.
      </AnimatedText>
    </div>
  );
}
