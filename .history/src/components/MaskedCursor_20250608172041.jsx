...
export default function MaskedCursor() {
  ...
  return (
    <>
      {/* Solid cursor (visible) */}
      <motion.div
        className="pointer-events-none fixed inset-0 z-[9999]"
        style={{
          WebkitMaskImage: "url('images/mask.svg')",
          WebkitMaskRepeat: 'no-repeat',
          backgroundColor: '#ec4e39', // Visible cursor color
        }}
        animate={{
      ...
      {/* Text-only effect (changes text color) */}
      <motion.div
        className="pointer-events-none fixed inset-0 z-[9998]" // Lower z-index
        style={{
          WebkitMaskImage: "url('images/mask.svg')",
          WebkitMaskRepeat: 'no-repeat',
          background: '#000', // Black background for text
          color: 'transparent',
