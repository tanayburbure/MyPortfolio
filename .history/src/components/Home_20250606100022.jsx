...
function Home() {
  return (
    <div className='relative flex items-center justify-center h-[100vh]'>
      ...
      <div>
        <div>
          <h1 className='absolute top-[22%] left-[2%] text-center text-[16vh] font-bold leading-[6.4vw] tracking-tighter'>
            STILL <br />
          ...
          <div>
            <h1 className='absolute top-[30%] right-[5%] text-center text-[16vh] font-bold leading-[6.4vw] tracking-tighter'>
              SINCE  <br />
            2023
            </h1>
          </div>
