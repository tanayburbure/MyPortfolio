  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center px-4 text-center">
        {/* Name */}
        <h3 className="font-[font4] font-bold tracking-tight mb-4 text-sm sm:text-base md:text-lg">
          T A N A Y &nbsp;&nbsp; B U R B U R E
        </h3>

        {/* Main Heading */}
        <h1 className="font-[font13] sm:w-[70%] font-normal tracking-tight leading-tight text-[6vh] sm:text-[9vh] md:text-[12vh]">
          STILL&nbsp;
