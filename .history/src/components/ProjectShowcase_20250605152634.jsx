    ...
    return (
        <div className="relative">
            <div
                ...
                ref={containerRef}
            >
                <div className="inline-block pl-[15.2%] relative">
                    <p
                    ...
                    <motion.p
                        ...
                        className="absolute top-0 left-0  text-[#b7ab98] px-[15%] pb-[1vh] mt-[-1vh] font-medium text-[8.2vw] leading-[6.5vw] pointer-events-none"
                    >
                        {project.title}
                    </motion.p>
                </div>
