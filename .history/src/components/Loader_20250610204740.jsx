  ...
  return (
    <div className={`h-screen flex items-center justify-center fixed top-0 left-0 w-full bg-[#0D0D0D] ${hideLoader ? 'hidden' : ''}`}>
      ...
      <button
        ...
        } hover:bg-[#EB5939] hover:text-[#0D0D0D] text-[2vh] absolute top-[55.5vh] px-12 py-[8px] pb-2 rounded-full border-[#b7ab98] hover:border-[border-[#b7ab98]] text-[#b7ab98] transition-all duration-500 ease-in-out`}
        aria-label="Start"
