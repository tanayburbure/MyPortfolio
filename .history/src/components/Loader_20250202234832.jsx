      ...
      <style>
        {`
          @keyframes drawCircle {
            ...
            100% {
              stroke-dashoffset: 188.5; /* Reverse and disappear from where it started */
              animation-timing-function: ease-in; /* Makes it reverse slowly */
            }
          }

          .circle {
            animation: drawCircle 6s ease-in-out forwards;
