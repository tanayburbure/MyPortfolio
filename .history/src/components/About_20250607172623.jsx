      ...
      <MaskReveal
        defaultContent={
          <div className='absolute top-[30vh]'>
            ...
            <AnimatedText className="text-[9vh] tracking-tighter  font-semibold leading-[4.5vw] text-[#afa18f]">
              I'm a <span className='text-[#EB5939]'>visually skilled</span> interactive web designer and developer with a strong focus on crafting high quality, impactful digital experience
            </AnimatedText>
          </div>
        }
        hoverContent={
