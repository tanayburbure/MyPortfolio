        ...
        <div className="relative">
            ...
            >
                <div className="inline-block pl-[6vw] md:pl-[15vw] lg:pl-[31vh] relative">
                    <p
                        className="text-[#2F2D29] font-thin text-[10vw] md:text-[8.2vw] leading-[8vw] md:leading-[6.5vw] cursor-pointer"
                    ...
                    <motion.p
                        ...
                        className="absolute top-0 left-[8vw] md:left-[15.6vw] text-[#b7ab98] font-thin text-[10vw] md:text-[8.2vw] leading-[8vw] md:leading-[6.5vw] pointer-events-none"
                    >
                        {project.title}
                    </motion.p>
                </div>
