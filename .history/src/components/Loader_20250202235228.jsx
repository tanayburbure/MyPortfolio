    ...
    <div style={styles.container}>
      ...
      <style>
        {`
          @keyframes drawCircle {
            0% {
              stroke-dashoffset: 188.5; /* Start with the circle fully "un-drawn" */
            }
            50% {
              stroke-dashoffset: 0; /* Fully visible at 50% */
            }
            100% {
              stroke-dashoffset: 188.5; /* Fully "un-drawn" again at 100% */
            }
          }

          @keyframes disappearCircle {
            0% {
              stroke-dashoffset: 0; /* Start disappearing from fully drawn */
            }
            100% {
              stroke-dashoffset: 188.5; /* Fully "un-drawn" again at the end */
            }
          }

          .circle {
            animation: drawCircle 3s ease-in-out forwards, disappearCircle 3s ease-in-out forwards 3s;
      ...
      <svg style={styles.svg} viewBox="0 0 64 64">
        <circle
          ...
          strokeDashoffset="188.5" /* Start with the circle fully "un-drawn" */
        />
      </svg>
    </div>
  );
