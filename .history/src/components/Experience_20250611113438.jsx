    ...
    <div className="relative w-full h-screen">
      ...
      <div
        ...
        style={{
          ...
          backgroundPositionX: window.innerWidth < 640 ? '70%' : undefined,
      ...
      <div className="relative h-full z-10 flex flex-col pt-[30vh] sm:pt-52 md:pt-60 lg:pt-48 px-[5vw] sm:px-[10vw] md:pl-[15vh] lg:pl-[31vh]">
        ...
        <AnimatedText className="text-[5vh] sm:text-[6.5vh] md:text-[8vh] lg:text-[9vh] font-[font9] cursor-expand mb-12 sm:mb-16 md:mb-20 tracking-tight w-[95%] font-semibold leading-[10.5vw] sm:leading-[5vw] md:leading-[4.5vw] lg:leading-[4.25vw]">
          Over
