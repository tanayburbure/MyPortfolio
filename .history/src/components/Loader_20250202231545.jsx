      ...
      <style>
        {`
          @keyframes drawCircle {
            0% {
              stroke-dashoffset: 188.5; /* Circumference of the circle */
            }
            100% {
              stroke-dashoffset: 0; /* End of the animation (circle fully drawn) */
            }
          }
          ...
          .circle {
            animation: drawCircle 2s linear forwards, rotate 2s linear forwards, fadeOut 1s 2s forwards;
          }
        `}
      </style>
