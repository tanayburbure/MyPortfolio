  ...
  return (
    ...
    >
      ...
      <div className="relative h-screen z-10 flex flex-col mt-12 pt-40 sm:pt-52 md:pt-60 px-[5vw] sm:px-[10vw] md:pl-[15vh] lg:pl-[31vh]">
        ...
        <AnimatedText className="text-[5vh] sm:text-[6.5vh] md:text-[8vh] lg:text-[9vh] font-[font9] cursor-expand mb-12 sm:mb-16 md:mb-20 tracking-tight w-[90%] font-semibold leading-[4.8vh] sm:leading-[5vw] md:leading-[4.5vw] lg:leading-[4.3vw]">
          Over
