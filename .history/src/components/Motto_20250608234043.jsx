  ...
  return (
    <div className="h-[100vh] relative overflow-hidden">
      ...
      <div className="top-[28%] left-0 right-0 absolute flex flex-col items-center text-center px-4 z-10 ">
        <h5 className="mb-8 font-semibold shadow-lg font-sm font-[font14] tracking-widest">M Y &nbsp; M O T T O</h5>
        <h2 className="text-[18vh] cursor-expand w-[60%] font-semibold tracking-tighter leading-[7vw]">
