      ...
      <MaskReveal
        defaultContent={
          <div className='absolute top-[30vh]'>
            ...
            <AnimatedText className="text-[7vh] tracking-tight w-[80%] font-semibold leading-[4.5vw] text-[#afa18f]">
              I'm a <span className='text-[#EB5939]'>visually skilled</span>Zinteractive web designer and developer with a strong focus on crafting high quality, impactful digital experiences.
            </AnimatedText>
          </div>
        }
        hoverContent={
