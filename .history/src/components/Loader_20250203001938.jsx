      ...
      <style>
        {`
          @keyframes drawClockwise {
            ...
            100% {
              stroke-dashoffset: 188.5; /* Circle remains fully drawn */
            }
          }

          @keyframes eraseCounterClockwise {
            0% {
              stroke-dashoffset: 0; /* Circle is fully drawn */
            }
            50% {
              stroke-dashoffset: 188.5; /* Circle is half erased */
            }
            100% {
              stroke-dashoffset: 188.5; /* Circle fully erased */
            }
          }

          .circle {
            animation: drawClockwise 3s ease-in-out forwards, eraseCounterClockwise 3s ease-in-out forwards;
