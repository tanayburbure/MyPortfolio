      ...
      <style>
        {`
          @keyframes drawCircle {
            ...
            50% {
              stroke-dashoffset: 0; /* Fully visible at 50% (clockwise drawing) */
            }
            100% {
              stroke-dashoffset: 188.5; /* Fully "drawn out" again at 100% (clockwise disappearing) */
            }
          }

          .circle {
            animation: drawCircle 3s linear import React from 'react';
      ...
      <style>
        {`
          ...
          @keyframes disappearCircle {
            ...
            100% {
              stroke-dashoffset: 188.5; /* Fully "drawn out" at the end (clockwise disappearing) */
            }
          }
...
export default Loader;; /* Loop the animation */
            transform: rotate(-90deg); /* Start drawing from the top */
            transform-origin: center;
          }
        `}
