    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="overflow-hidden mb-1 w-full max-w-[95vw] sm:max-w-[90vw]">
          <h1
            ref={mainHeadingRef}
            className="split-text-fix main-heading font-[font13] text-[#EB5939] text-[14vw] sm:text-[10vw] md:text-[12vw] lg:text-[9vw] leading-[10vw] lg:leading-[10vw]  tracking-tight cursor-expand"
          >
            STILL
            <br />
            DEBUGGING
