...
function About() {
  return (
    <div className='h-screen pl-[5vw] md:pl-[15vh] lg:pl-[31vh] flex flex-col justify-center mt-16'>
      ...
      <AnimatedText className="text-[5vh] sm:text-[6vh] md:text-[7vh] lg:text-[8.5vh] font-[font9] tracking-tight sm:tracking-normal w-[97%] sm:w-[85%] md:w-[80%] lg:w-[77%] font-semibold leading-[9.5vw] sm:leading-[7vw] md:leading-[10vh] lg:leading-[3.95vw] cursor-expand">
