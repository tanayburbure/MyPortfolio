  ...
  return (
    <div className='bg-[#0D0D0D] h-[100vh] relative w-full flex items-center justify-center'>
      ...
      <div className='animate'>
        ...
        {/* SVG Circle */}
        <svg style={{ width: '14.5vw', height: '14.5vw' }} viewBox="0 0 64 64">
          <circle
            className="circle"
            cx="32"
            cy="32"
      ...
      <img
        ...
        alt="Animated Logo"
      />
      <button className='border-[1px] hidden text-[2vh] absolute top-[56vh] px-8 py-[1px] pb-1 rounded-full border-[#b7ab98] text-[#b7ab98]'>S T A R T</button>
    </div>
  );
}
