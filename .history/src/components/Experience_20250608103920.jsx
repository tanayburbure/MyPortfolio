  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col mt-12 pt-60">
        <h5 className="text-sm font-semibold mb-6 pl-[31vh]">
          E X P E R I E N C E
        </h5>

        <AnimatedText className="text-[9vh] cursor-expand mb-20 pl-[31vh] tracking-tighter w-[77%] font-semibold leading-[4.5vw] text-white">
