    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full">
        <div className="absolute top-[21%]">
          <h3 className="tracking-tight  text-center text-lg font-bold text-center mb-8 mr-4">
            T A N A Y &nbsp;&nbsp; B U R B U R E
          </h3>

          <h1 className="text-center  text-center text-[16vh] font-bold leading-[6.4vw] tracking-tighter">
            STILL <br />
