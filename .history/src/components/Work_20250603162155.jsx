        ...
        <div className="relative">
            ...
            >
                <div className="inline-block pl-[15%] relative">
                    {/* Bottom layer: initial color (#2F2D29) */}
                    <p className="text-[#2F2D29] p-2 font-medium text-[8vw] leading-[6.5vw] absolute top-0 left-0 z-0">
                        {project.title}
                    </p>

                    {/* Top layer: scroll-revealed color (#b7ab98) */}
                    <motion.p
                        style={{ clipPath: clipPathStyle }}
                        className="text-[#b7ab98] p-2 font-medium text-[8vw] leading-[6.5vw] relative z-10"
                    >
                        {project.title}
                    </motion.p>
                </div>
