  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div className="relative z-10 pt-56 pl-[31.4vh] flex flex-col justify-center">
        <h5 className="mb-8 font-semibold shadow-lg font-sm font-[font14] tracking-widest pl-[10vh]">C L I E N T S</h5>
        <AnimatedText className="text-[9vh] w-[78%] tracking-tight font-medium leading-[4vw] cursor-expand">
