      ...
      >
        <div className="pl-[15%] py-2 relative">
          <div className="relative inline-block">
            ...
            {/* Overlay scroll-reveal text: always visible, scroll-revealed */}
            <motion.span
              style={{ clipPath: clipPathStyle }}
              className="absolute top-0 left-0 w-full text-[8vw] leading-[6.5vw] font-medium text-[#B7AB98] z-10 pointer-events-none"
            >
              {project.title}
            </motion.span>
          </div>
