...
function Footer() {
  return (
    <div className="h-[50vh] flex flex-col w-full ">
      ...
      <h3 className="text-center tracking-normal font-medium text-mg pt-2 text-[#B7AB98] font-[font14]">Design inspired by &nbsp; <span className="text-[#EB5939]">M I N H  &nbsp; P H A M</span></h3>
    </div>
  );
}
