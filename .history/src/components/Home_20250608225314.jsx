  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full absolute top-[28%]">
          <h3 className="tracking-tight text-lg font-extrabold text-center mb-20 mr-6 font-[font14]">
            T A N A Y &nbsp;&nbsp; B U R B U R E
          </h3>

          <h1 className="text-center text-[16.5vh] font-black leading-[6.4vw] tracking-[-0.8vh] cursor-expand font-[font12]">
            STILL&nbsp;
