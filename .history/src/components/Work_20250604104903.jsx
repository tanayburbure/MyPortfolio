...
export default function Work() {
  ...
  return (
    <>
      <h5 className="z-50 sticky top-0 pb-6 pl-[15.4vw] shadow-lg bg-white">
        W H A T &nbsp; I &nbsp; D O
      </h5>
    ...
    <div className="relative">
      ...
      >
        <div className="inline-block pl-[15%] relative">
          ...
          {/* Highlighted text with clip-path animation */}
          <motion.p
  ...
  return (
    <div className="absolute top-[-3vh] mt-[2.85vh] w-screen z-20 pointer-events-none">
      {projects.map((project, index) => (
        ...
        >
          <p className="text-[#010101] font-medium mb-3 leading-[6.5vw] text-[8.2vw] relative z-10">
