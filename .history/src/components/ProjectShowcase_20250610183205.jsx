    ...
    return (
        <div className="relative">
            <div
                ...
                ref={containerRef}
            >
                <div className="inline-block md:pl-[15vw] lg:pl-[31vh] relative">
                    <p
                        className="text-[#2F2D29] font-thin text-[6.7vh] md:text-[8.2vw] leading-[7.5vh] md:leading-[6.5vw] cursor-pointer"
                    ...
                    <motion.p
                        style={{ clipPath: clipPathStyle }}
                        className="absolute top-0 md:left-[15.6vw] text-[#b7ab98] font-thin text-[6.7vh] md:text-[8.2vw] leading-[7.5vh] md:leading-[6.5vw] pointer-events-none"
                    >
                        {project.title}
                    </motion.p>
                </div>
...
function Descriptions({ projects, selectedProject, isMobile }) {
    return (
        <div className="absolute top-[-3vh] mt-[3.05vh] w-screen z-2 pointer-events-none">
            {projects.map((project, index) => (
                <div
                    key={index}
                    className="bg-[#ec4e39] h-[7.6vh] md:h-[6.8vw] pt-2 text-[#0D0D0D] font-thin flex flex-col md:flex-row justify-between items-center px-[5%] md:px-[15%] transition-all duration-500 ease-in-out"
                    style={{
                        clipPath: selectedProject === index ? "inset(0 0 0)" : "inset(50% 0 50%)",
                    }}
                >
                    <p className="text-[#010101] font-thin mb-1 md:mb-1 leading-[8vw] md:leading-[6.5vw] text-[6vw] md:text-[8.2vw] relative z-1">
                        {project.title.substring(0, isMobile ? 10 : 9)}
                    </p>
