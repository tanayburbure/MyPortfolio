        ...
        <div className="relative">
            ...
            >
                <div className="inline-block pl-[5vw] md:pl-[15vw] lg:pl-[31vh] relative">
                    ...
                    <motion.p
                        style={{ clipPath: clipPathStyle }}
                        className="absolute top-0 left-[8vw] sm:left-[8vw] md:left-[10vw] lg:left-[1.6vw] text-[#b7ab98] font-thin text-[6vh] sm:text-[5.5vw] md:text-[6vw] lg:text-[8.2vw] leading-[6.5vh] sm:leading-[5.5vw] md:leading-[5.8vw] lg:leading-[6.5vw] pointer-events-none"
                    >
                        {project.title}
                    </motion.p>
                </div>
