    ...
    <div className="h-[50vh] flex flex-col w-full ">
      <div className="pl-[32vh] pt-[15vh] px-48">
        ...
        <div className="grid grid-cols-3">
          ...
          <div className="flex flex-col pt-3 text-lg">
            <a href="mailto:tanayburbure@gmail.com" className="flex items-center pb-2">
              <IoMdMail className="mr-2" />
              tanayburbure@gmail.com
            </a>
            <a href="tel:+918421881858" className="flex items-center">
