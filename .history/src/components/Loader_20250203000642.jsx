...
function Loader() {
  return (
    <div style={styles.container}>
      ...
      <style>
        {`
          @keyframes eraseAndDraw {
            0% {
              stroke-dashoffset: 0; /* Start with the circle fully drawn */
            }
            50% {
              stroke-dashoffset: 188.5; /* Fully erased at the halfway point */
            }
            100% {
              stroke-dashoffset: 0; /* Draw back to the fully drawn state */
            }
          }

          .circle {
            animation: eraseAndDraw 6s ease-in-out forwards;
            transform: rotate(-90deg); /* Start drawing from the right side */
      ...
      <svg style={styles.svg} viewBox="0 0 64 64">
        <circle
          ...
          strokeDashoffset="0" /* Start with the circle fully drawn */
        />
      </svg>
    </div>
  );
