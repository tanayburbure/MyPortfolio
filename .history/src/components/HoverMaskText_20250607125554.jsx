...
const HoverMaskText = () => {
  ...
  return (
    <main className="relative h-screen w-full overflow-hidden">
      <motion.div
        className="absolute inset-0 z-[99999] flex items-center justify-center text-black"
        animate={{
      ...
      >
        <p
          ...
          className="w-[1000px] p-10 text-[64px] leading-[66px] text-black cursor-default"
        >
