...
function Experience() {
  ...
  return (
    <div
      className="bg-fixed w-full bg-center bg-cover min-h-[120vh] relative"
      style={{
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-full h-8 bg-gradient-to-t from-[#0D0D0D] to-transparent z-10 pointer-events-none" />
