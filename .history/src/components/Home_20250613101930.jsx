...
function Home() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {/* Main Content */}
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center lg:px-4 pr-1 text-center overflow-hidden">
        {/* Name */}
        <h3 className="font-[font14] mt-[-4vh] font-bold tracking-tight lg:mb-4 text-sm sm:text-base md:text-lg">
          T A N A Y &nbsp;&nbsp; B U R B U R E
        </h3>

        {/* Main Heading (with hidden overflow for animation) */}
        <div className="overflow-hidden">
          <h1
            ref={mainHeadingRef}
            className="font-[font13] cursor-expand leading-[7.3vh] font-normal tracking-tight text-[8vh] mt-8 lg:text-[9vw] md:text-[12vh]"
          >
            STILL{isMobile ? <br /> : ' '}
        ...
        <div className="overflow-hidden mt-2 lg:mt-4">
          <h1
            ref={subtitleRef}
            className="font-[font9] font-semibold tracking-tight text-[3.5vh] sm:text-[4.5vh] md:text-[5.5vh] lg:text-[4vw]"
          >
            SINCE 2023
          </h1>
        </div>
