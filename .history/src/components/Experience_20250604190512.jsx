...
function Experience() {
  ...
  return (
    <div className='mb-42 flex flex-col justify-center'>
      <h5 className='text-sm font-semibold mb-6 pl-[31vh]'>E X P E R I E N C E</h5>
      <div ref={textRef}>
        <h2 className='text-[9vh] pl-[31vh] tracking-tighter w-[77%] font-semibold leading-[4.5vw] text-transparent bg-gradient-to-r from-[#212121] to-[#B7AB98] bg-[length:200%_100%] bg-right bg-clip-text [-webkit-background-clip:text]'>
