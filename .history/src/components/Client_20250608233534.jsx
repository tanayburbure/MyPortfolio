...
const Client = () => {
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div className="relative z-10 pt-56 pl-[31.4vh] flex flex-col justify-center">
        <h5 className="mb-8 font-semibold shadow-lg font-sm font-[font14] tracking-widest">C L I E N T S</h5>
        <AnimatedText className="text-[9vh] font-[font9] cursor-expand mb-20  tracking-tight w-[80%] font-semibold leading-[4.3vw]">
          I worked with some of the most <span className="text-[#EB5939] font-[font8] tracking-regular">innovative</span> industry leaders.
        </AnimatedText>
      </div>

      {/* Showcase (z-10 to stay on top) */}
      <div className="relative z-10 top-[29vh]">
