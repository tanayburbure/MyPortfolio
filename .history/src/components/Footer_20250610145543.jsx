...
function Footer() {
  return (
    <div className="h-auto min-h-[50vh] flex flex-col w-full">
      <div className="pl-[5vw] sm:pl-[10vw] md:pl-[15vw] lg:pl-[32vh] pt-[5vh] sm:pt-[10vh] lg:pt-[15vh] px-4 sm:px-8 md:px-12 lg:px-48 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 no-mask font-[font8] gap-6 md:gap-8 lg:gap-0">
            ...
            <li className="flex items-center">
              ...
              <HoverAnimation>
                <a
                  ...
                  className="mr-[4vw] sm:mr-[8vw] md:mr-[10vw] lg:mr-[13vh] tracking-tight"
                >
                  Instagram
                </a>
              </HoverAnimation>
            </li>
            <li className="flex items-center mt-4 sm:mt-6">
              <i className="ri-send-plane-2-fill text-[#EB5939] text-[1.8vh] sm:text-[2vh] md:text-[2.2vh] lg:text-[2.5vh]"></i>
              <HoverAnimation>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="tracking-tight mr-[4vw] sm:mr-[8vw] md:mr-[10vw] lg:mr-[13.8vh]"
                >
                  Facebook
                </a>
              </HoverAnimation>
            ...
            <li className="flex items-center">
              ...
              <HoverAnimation>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="tracking-tight mr-[4vw] sm:mr-[8vw] md:mr-[10vw] lg:mr-[14vh]"
                >
                  Telegram
                </a>
              </HoverAnimation>
            ...
            <li className="flex items-center mt-4 sm:mt-6">
              ...
              <HoverAnimation>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="tracking-tight mr-[4vw] sm:mr-[8vw] md:mr-[10vw] lg:mr-[16vh]"
                >
                  Linkedin
                </a>
              </HoverAnimation>
          ...
          <ul className="pt-1 md:pt-0 lg:pt-1">
            <li className="pb-3 flex items-center text-[2vh] sm:text-[2.3vh] md:text-[2.5vh] lg:text-[2.7vh]">
              <i className="ri-mail-fill text-[#EB5939] text-[1.8vh] sm:text-[2vh] md:text-[2.2vh] lg:text-[2.5vh]"></i>
              &nbsp; 
              <HoverAnimation>
                <a href="mailto:tanayburbure@gmail.com" className="pb-1 mr-2 sm:mr-3 md:mr-4">
            ...
            <li className="flex items-center text-[1.8vh] sm:text-[2vh] md:text-[2.3vh] lg:text-[2.5vh]">
              ...
              &nbsp;
              <HoverAnimation>
                <a className="mb-1 mr-8 sm:mr-16 md:mr-20 lg:mr-24" href="tel:+918421881858">
                  +91-8421881858
                </a>
              </HoverAnimation>
            </li>
