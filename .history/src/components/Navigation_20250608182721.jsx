  ...
  return (
    <div className='relative z-50 fixed h-full w-screen'>
      ...
      <div className='absolute top-12 right-16 flex flex-col'>
        <button className='nav-button no-mask' onClick={() => smoothScroll("#about")}>About</button>
        <button className='nav-button no-mask' onClick={() => smoothScroll("#work")}>Work</button>
        <button className='nav-button no-mask' onClick={() => smoothScroll("#contact")}>Contact</button>
      </div>
