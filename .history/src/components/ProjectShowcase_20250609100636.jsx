        ...
        <div className="relative">
            ...
            >
                <div className="inline-block pl-[15%] relative ">
                    <p
                        className="text-[#2F2D29] font-bold text-[7.5vw] pt-4 leading-[6.5vw] cursor-pointer"
                    ...
                    <motion.p
                        ...
                        className="absolute top-0 left-[14.85vw] text-[#b7ab98] pt-4 font-bold text-[7.5vw] leading-[6.5vw] pointer-events-none"
                    >
                        {project.title}
                    </motion.p>
                </div>
...
function Descriptions({ projects, selectedProject }) {
    return (
        <div className="absolute top-[-2.8vh] mt-[2.85vh] w-screen z-2 pointer-events-none font-[font9]">
            {projects.map((project, index) => (
                <div
                    key={index}
