  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      requestId = requestAnimationFrame(() => {
        // On mobile, match scroll position 1:1 (normal scroll behavior)
        // On desktop, use the original parallax factor (0.02)
        setOffsetY(isMobile ? window.scrollY : window.scrollY * 0.02);
        requestId = null;
      });
    };
