    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center px-4 text-center">
        ...
        <div className="overflow-hidden mb-1 w-full max-w-[95vw] sm:max-w-[90vw]">
          <h1
            ref={mainHeadingRef}
            className="font-[font13] text-[#EB5939] text-[6.5vh] sm:text-[8vh] md:text-[12vh] lg:text-[9vw] leading-none font-normal tracking-tight cursor-expand whitespace-nowrap"
          >
            STILL DEBUGGING
          </h1>
        </div>
