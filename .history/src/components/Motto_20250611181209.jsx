...
function Motto() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      requestId = requestAnimationFrame(() => {
        // Unified scroll direction - always moves up on scroll
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      {/* Background with proper movement */}
      <div
        ...
        style={{
          ...
          // Mobile: moves down slightly (prevents zoom)
          // Desktop: moves up normally (standard parallax)
