  ...
  return (
    <div style={styles.container}>
      ...
      <img
        ...
        alt="Animated Logo"
      />
      <button className={`border-[1px] ${showButton ? 'block fadeIn' : 'hidden'} hover:bg-[] text-[2vh] absolute top-[55.5vh] px-12 py-[8px] pb-2 rounded-full border-[#b7ab98] text-[#b7ab98]`}>
        S T A R T
      </button>
    </div>
  );
