...
<div className="mb-1 px-2 w-full max-w-[95vw]">
  <h1
    ref={mainHeadingRef}
    className="font-[font13] text-[#EB5939] text-[6vh] sm:text-[8vh] md:text-[12vh] lg:text-[9vw] leading-none font-normal tracking-tight cursor-expand break-words"
  >
    STILL DEBUGGING
  </h1>
</div>
...
{/* Animated Subtitle */}
<div className="px-2 w-full max-w-[90vw]">
  <h1
    ref={subtitleRef}
    className="font-[font9] font-semibold text-[2.8vh] sm:text-[4vh] md:text-[5.5vh] lg:text-[4vw] tracking-tight leading-none"
  >
    SINCE 2023
  </h1>
</div>
