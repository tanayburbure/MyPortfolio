...
function Experience() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-fixed bg-contain">
      ...
      <div
        ...
        style={{
          ...
          backgroundPositionX: isMobile ? '80%' : 'center',
      ...
      {/* Main Content Layer */}
      <div className="relative z-10 h-full flex flex-col mt-12 pt-40 sm:pt-52 md:pt-60 px-[5vw] sm:px-[10vw] md:pl-[15vh] lg:pl-[31vh]">
