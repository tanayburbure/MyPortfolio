...
export default function Work() {
  return (
    <div className="pl-5 h-[80vh] lg:h-[88vh] mt-24">
      <h5 className="z-50 pl-1 top-0 mb-8 lg:mb-12 lg:pl-[14.85vw] font-semibold shadow-lg font-sm font-[font14] tracking-widest">
        W H A T &nbsp; I &nbsp; D O
      </h5>
