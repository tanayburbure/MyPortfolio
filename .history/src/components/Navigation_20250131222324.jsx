...
function Navigation() {
    return (
        <div className=' z-50 fixed h-[100vh] w-[100vw] text-white'>
            <div className='left absolute top-12 left-12'>
                <img className='h-12 ' src="public/images/logo.svg" alt="" />
            </div>
            ...
            <div className='text-[2.5vh] z-50 absolute top-[67vh] gap-8 left-12 flex flex-col'>
                <IoLogoFacebook />
                <AiFillInstagram />
                <FaTwitter />
                <IoLogoLinkedin />
