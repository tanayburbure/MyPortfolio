...
export default function Home({ isLoaded }) {
  ...
  useEffect(() => {
    ...
    const startAnimation = async () => {
      ...
      // 🔑 CRITICAL FIX:
      // Hide text BEFORE SplitText touches the DOM
      gsap.set([mainHeadingRef.current, subtitleRef.current], {
        visibility: 'hidden',
      });
      ...
      ctx = gsap.context(() => {
        ...
        // Reveal once chars are ready
        gsap.set(
          [...splitMain.chars, ...splitSub.chars],
          { visibility: 'visible' }
        );
