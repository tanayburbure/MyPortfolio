  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center lg:px-4 pr-1 text-center">
        ...
        {/* Main Heading */}
        <h1 className="font-[font13] leading-[7.3vh] font-normal tracking-tight leading-[7.5vh] text-[8vh] mt-20 lg:text-[9vh] md:text-[12vh]">
          STILL{isMobile ? <br /> : ' '}
          <span className="text-[#EB5939] text-[7.9vh] lg:text-[9vh] pr-1">DEBUGGING</span>
        </h1>
