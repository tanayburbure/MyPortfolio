...
function Navigation() {
  ...
  <button
    className="no-mask flex flex-col items-center"
    onClick={toggleMusic}
    style={{
      writingMode: "vertical-rl",
      transform: "rotate(180deg)",
      lineHeight: 1.2,
      width: '2.5ch',       // Reserve width for 3 chars like 'OFF'
      textAlign: 'center',
      minHeight: '3.5em',   // optional: keep height consistent too
    }}
  >
    <span>Sound</span>
    <span style={{ fontWeight: 'bold', display: 'inline-block', width: '2.5ch' }}>
