...
function About() {
  return (
    <div className='h-screen pl-[5vw] md:pl-[15vh] lg:pl-[31vh] pb-4 flex flex-col justify-center'>
      ...
      <AnimatedText className="text-[5vh] sm:text-[6vh] md:text-[7vh] lg:text-[8vh] font-[font9] tracking-tight sm:tracking-normal w-[95%] sm:w-[85%] md:w-[80%] lg:w-[77%] font-semibold leading-[7vw] sm:leading-[7vw] md:leading-[4.5vw] lg:leading-[6vw] cursor-expand">
