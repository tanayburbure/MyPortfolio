  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full absolute top-[28%]">
          ...
          <h1 className="text-center text-[18vh] font-extrabold leading-[6.4vw] tracking-[-1.2vh] cursor-expand font-[font9]">
            STILL&nbsp;
            <span className="text-[#EB5939]">DEBUGGING <br /></span>
          </h1>
          <h3 className='text-center text-[7vh] font-semibold cursor-expand font-[font9]'>SINCE 2023</h3>
      </div>
    </div>
  );
}
