    ...
    return (
        <div>
            <div className="mt-[15vh] flex flex-col justify-center">
                <h5 className="text-xm mb-6 pl-[31.4vh]">C L I E N T S</h5>
                <div ref={textRef}>
                    <h2 className="text-[9vh] pl-[31.4vh] w-[78%] tracking-tight font-medium leading-[4vw] text-transparent bg-gradient-to-r from-[#212121] to-[#B7AB98] bg-[length:200%_100%] bg-right bg-clip-text [-webkit-background-clip:text]">
