  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div className="relative h-full z-10 flex flex-col items-center justify-center">
        ...
        <h2 className="font-light pr-2 tracking-tighter text-[10vh] text-center sm:text-[12vh] md:text-[14vh] lg:text-[16.4vh] text-[#EC4E39] font-[font13] cursor-expand w-full sm:w-[100%] md:w-[70%] lg:w-[60%] leading-[9vh] sm:leading-[8vw] md:leading-[7.5vw]">
