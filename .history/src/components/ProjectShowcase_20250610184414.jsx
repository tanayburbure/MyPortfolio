        ...
        <div className="relative">
            ...
            >
                <div className="inline-block pl-[7.8vw] md:pl-[1vw] lg:pl-[31vh] relative">
                    <p
                        className="text-[#2F2D29] font-thin text-[6vh] sm:text-[5vw] md:text-[5vw] lg:text-[8.2vw] leading-[6.5vh] sm:leading-[5.5vw] md:leading-[5.8vw] lg:leading-[6.5vw] cursor-pointer"
