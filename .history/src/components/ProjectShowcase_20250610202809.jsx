    ...
    return (
        <div className="relative">
            <div
                ...
                ref={containerRef}
            >
                <div className="inline-block pl-[7.8vw] md:pl-[1vw] lg:pl-[14.2vw] relative">
                    <p
                    ...
                    <motion.p
                        style={{ clipPath: clipPathStyle }}
                        className="absolute top-0 left-[8vw] sm:left-[12vw] md:left-[1vw] lg:left-[14.2vw] text-[#b7ab98] font-thin text-[6vh] sm:text-[5.5vw] md:text-[6vw] lg:text-[8.2vw] leading-[6.5vh] sm:leading-[5.5vw] md:leading-[5.8vw] lg:leading-[6.5vw] pointer-events-none"
                    >
                        {project.title}
                    </motion.p>
                </div>
