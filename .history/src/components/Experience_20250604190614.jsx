...
function Experience() {
  ...
  return (
    <div className='flex flex-col mt-12 justify-center'>
      ...
      <div ref={textRef}>
        <h2 className='text-[9vh] mb-12 pl-[31vh] tracking-tighter w-[77%] font-semibold leading-[4.5vw] text-transparent bg-gradient-to-r from-[#212121] to-[#B7AB98] bg-[length:200%_100%] bg-right bg-clip-text [-webkit-background-clip:text]'>
