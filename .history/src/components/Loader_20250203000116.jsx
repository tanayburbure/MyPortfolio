      ...
      <style>
        {`
          @keyframes drawAndErase {
            ...
            50% {
              stroke-dashoffset: 0; /* Fully drawn at the halfway point */
            }
            100% {
              stroke-dashoffset: 188.5; /* Erase from the same direction it was drawn */
            }
          }

          .circle {
            animation: drawAndErase 6s ease-in-out forwards;
