...
function About() {
  return (
    <div className='h-[100vh] relative overflow-x-hidden'>
      <MaskReveal
        defaultContent={
          <div className='absolute top-[30vh] left-[20vw] pr-40 w-[70%] '>
  <h5 className='text-sm font-semibold mb-6 text-[#afa18f]'>A B O U T &nbsp; M E</h5>
  <AnimatedText className="text-[9vh] tracking-tighter w-[100%] font-semibold leading-[4.5vw] text-[#afa18f] whitespace-nowrap">
