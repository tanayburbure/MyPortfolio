        ...
        <div className="relative">
            ...
            >
                <div className="inline-block pl-[15%] relative">
                    <p
                        className="text-[#2F2D29] font-medium text-[8.2vw] leading-[6.5vw] cursor-pointer"
                    ...
                    <motion.p
                        ...
                        className="absolute top-0 left-[14.85vw] text-[#b7ab98]  font-medium text-[8.2vw] leading-[6.5vw] pointer-events-none"
                    >
                        {project.title}
                    </motion.p>
                </div>
...
function Descriptions({ projects, selectedProject }) {
    return (
        <div className="absolute top-[-3vh] mt-[3.35vh] w-screen z-2 pointer-events-none">
            {projects.map((project, index) => (
                <div
                    key={index}
                    className="bg-[#ec4e39] h-[6.8vw] pt-2 text-[#0D0D0D] font-medium flex justify-between items-center px-[15%] transition-all duration-500 ease-in-out"
                    style={{
