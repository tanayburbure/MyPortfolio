      ...
      <style>
        {`
          @keyframes drawCircle {
            ...
            100% {
              stroke-dashoffset: 188.5; /* Fully "drawn out" again at 100% */
            }
          }

          @keyframes rotate {
            0% {
              transform: rotate(0deg); /* Start rotation from the top (0 degrees) */
            }
            100% {
              transform: rotate(360deg); /* Complete a full rotation and end at the top */
            }
          }

          .circle {
            animation: drawCircle 3s ease-in-out forwards, rotate 3s linear infinite;
          }
        `}
      </style>
