...
function Navigation() {
  ...
  return (
    <div className='relative z-50 fixed h-full w-screen'>
      ...
      <div className='absolute top-12 right-16 flex flex-col items-end font-[font9] text-lg tracking-tight'>
...
export default Navigation;  make it responsive and hide the social div for mobile screen