...
function Earth(props) {
  ...
  const [earthTexture, bumpMap, specularMap, cloudsTexture] = useTexture([
    '/textures/earth_daymap.jpg',     // Replace with your texture paths
    '/textures/earth_normalmap.jpg',  // Normal/bump map
    '/textures/earth_specularmap.jpg', // Specular map
    '/textures/earth_clouds.jpg'      // Clouds texture
  ])
