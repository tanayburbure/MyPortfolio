...
function Motto() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      {/* Background with locked mobile sizing */}
      <div
        ...
        style={{
          ...
          backgroundPositionY: isMobile 
            ? `calc(70% + ${offsetY}px)`  // Adjusted mobile position
            : `calc(230% + ${offsetY}px)`, // Original desktop position
          backgroundSize: isMobile 
            ? `${window.innerWidth * 1.2}px auto` // Locked width-based size
            : 'cover',
