...
<h1
  ref={subtitleRef}
  className="split-text-fix mt-12 font-[font9] font-semibold text-[3vh] sm:text-[4.5vh] md:text-[5.5vh] lg:text-[4vw] tracking-tight leading-none whitespace-nowrap"
>
  SINCE 2023
</h1>
