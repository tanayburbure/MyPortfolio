            ...
            >
                <div className="inline-block pl-[15%]">
                    <motion.p
                        ...
                        className="text-[#b7ab98] p-1 font-medium text-[8vw] leading-[6.5vw] relative z-2"
                    >
                        {project.title}
                    </motion.p>
    ...
    return (
        <div className="absolute top-0 h-full w-full z-2 pointer-events-none">
            {projects.map((project, index) => (
                ...
                >
                    <p className="text-[#010101] m uppercase font-semibold text-[8vw] leading-[7.1vw] relative z-1">
