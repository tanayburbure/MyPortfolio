  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center lg:px-4 pr-1 text-center">
        ...
        {/* Main Heading */}
        <h1 className="font-[font13] cursor-expand leading-[7.3vh] font-normal tracking-tight leading-[7.5vh] text-[8vh] mt-20 lg:text-[9vw] md:text-[12vh]">
          STILL{isMobile ? <br /> : ' '}
          <span className="text-[#EB5939] text-[7.8vh] lg:text-[9vw] pr-2">DEBUGGING</span>
        </h1>

        {/* Subtitle */}
        <h3 className="font-[font9] font-semibold tracking-tight mt-2 text-[3.5vh] sm:text-[4.5vh] md:text-[5.5vh] lg:text-[3.5vw]">
          SINCE 2023
        </h3>
      </div>
    </div>
