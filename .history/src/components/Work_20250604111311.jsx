...
// Add the missing Descriptions component
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
      {projects.map((project, index) => (
        <motion.div
          key={index}
          className="absolute top-0 left-0 w-full bg-[#ec4e39] flex justify-between items-center px-[15%]"
          style={{ height: '6.6vw' }}
          initial={{ 
          ...
          animate={{
            ...
            zIndex: selectedProject === index ? 10 : 0
          }}
          transition={{ 
            duration: 0.3, 
            ease: "easeInOut",
        ...
        >
          <p className="text-[#010101] font-medium leading-[6.5vw] text-[8.2vw]">
