            ...
            >
                <div className="inline-block pl-[15%] relative">
                    ...
                    <motion.p
                        ...
                        className="absolute top-0 left-0 text-[#b7ab98] pb-[1vh] mt-[-1vh] font-medium text-[8.2vw] leading-[6.5vw] pointer-events-none"
                    >
                        {project.title}
                    </motion.p>
                </div>
    ...
    return (
        <div className="absolute top-[-3vh] mt-[2.85vh] w-screen z-2 pointer-events-none">
            {projects.map((project, index) => (
                ...
                >
                    <p className="text-[#010101] font-medium mb-3 leading-[6.5vw] text-[8.2vw] px-[15%] relative z-1">
