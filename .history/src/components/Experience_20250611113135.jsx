...
function Experience() {
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div className="relative h-full z-10 flex flex-col pt-[35vh] sm:pt-52 md:pt-60 lg:pt-48 px-[5vw] sm:px-[10vw] md:pl-[15vh] lg:pl-[31vh]">
        <h5 className="mb-6 sm:mb-8 lg:mb-12 font-semibold font-sm font-[font14] tracking-widest text-xs sm:text-sm md:text-base">
          E X P E R I E N C E
        </h5>

        <AnimatedText className="text-[5vh] sm:text-[6.5vh] md:text-[8vh] lg:text-[9vh] font-[font9] cursor-expand mb-12 sm:mb-16 md:mb-20 tracking-tight w-[95%] font-semibold leading-[4.8vh] sm:leading-[5vw] md:leading-[4.5vw] lg:leading-[4.25vw]">
          Over
