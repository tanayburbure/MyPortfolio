    ...
    <div style={styles.container}>
      ...
      <style>
        {`
          ...
          @keyframes rotate {
            0% {
              transform: rotate(-90deg); /* Start rotation from the top */
            }
            100% {
              transform: rotate(270deg); /* End rotation at the top */
            }
          }

          .circle {
            animation: drawCircle 3s ease-in-out forwards, rotate 3s linear;
          }
        `}
      </style>
