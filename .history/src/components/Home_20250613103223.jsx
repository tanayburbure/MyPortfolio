    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center px-4 text-center">
        ...
        <div className="overflow-hidden mb-1">
          <h1
            ref={mainHeadingRef}
            className="font-[font13]  text-[8vh] md:text-[12vh] lg:text-[9vw] leading-none font-normal tracking-tight"
          >
            STILL <span className='text-[#EB5939]'>DEBUGGING</span>
          </h1>
        </div>
        ...
        <div className="overflow-hidden">
          <h1
            ref={subtitleRef}
            className="font-[font9] font-semibold text-[3.5vh] sm:text-[4.5vh] md:text-[5.5vh] lg:text-[4vw] tracking-tight leading-none"
          >
            SINCE 2023
          </h1>
        </div>
