...
const Client = () => {
  return (
    <div className="relative w-full mt-20 overflow-hidden">
      ...
      <div className="relative z-10 pt-32 lg:pt-56 px-4 lg:pl-[31vh] flex flex-col justify-center">
        <h5 className="mb-4 lg:mb-12 font-semibold shadow-lg text-xs lg:text-[1.5vh] tracking-widest">C L I E N T S</h5>
        <AnimatedText className="text-4xl lg:text-[9vh] cursor-expand mb-12 lg:mb-20 tracking-tight w-full lg:w-[80%] font-semibold leading-[9.8vw] lg:leading-[4.1vw]">
