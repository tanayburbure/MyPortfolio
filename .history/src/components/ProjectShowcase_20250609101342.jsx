        ...
        <div className="relative">
            ...
            >
                <div className="inline-block pl-[15%] relative ">
                    <p
                        className="text-[#2F2D29] font-bold text-[7.5vw] pt-5 leading-[6.5vw] cursor-pointer"
                    ...
                    <motion.p
                        ...
                        className="absolute top-0 left-[14.85vw] text-[#b7ab98] pt-5 font-bold text-[7.5vw] leading-[6.5vw] pointer-events-none"
                    >
                        {project.title}
                    </motion.p>
                </div>
...
function Descriptions({ projects, selectedProject }) {
    return (
        <div className="absolute top-[-4vh] pt-12 w-screen z-2 pointer-events-none font-[font9]">
            {projects.map((project, index) => (
                <div
                    key={index}
                    className="bg-[#ec4e39] pt-16 h-[6.6vw] text-[#0D0D0D] font-bold flex justify-between items-center px-[14.8%] transition-all duration-500 ease-in-out"
                    style={{
                        clipPath: selectedProject === index ? "inset(0 0 0)" : "inset(50% 0 50%)",
                    }}
                >
                    <p className="text-[#010101] font-bold mb-6 leading-[6.5vw] text-[7.5vw] relative z-1">
