...
function About() {
  return (
    <div className='h-[100vh] relative '>
      <MaskReveal
        defaultContent={
          <div className='absolute top-[30vh] left-[20vw] mr-40 whitespace-nowrap'>
  <h5 className='text-sm font-semibold mb-6 text-[#afa18f]'>A B O U T &nbsp; M E</h5>
  <AnimatedText className="text-[9vh] tracking-tighter font-semibold leading-[4.5vw] text-[#afa18f] whitespace-nowrap">
