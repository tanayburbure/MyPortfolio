...
function Title({ project, index, setSelectedProject }) {
    ...
    // Animate clipPath from full right (hides light color) to full left (reveals light color)
    ...
    return (
        <div className="relative">
            ...
            >
                {/* Base dark text using background gradient */}
                <motion.p
                    style={{
                        backgroundImage: "linear-gradient(to right, #B7AB98 0%, #2F2D29 0%)",
                        WebkitBackgroundClip: "text",
                        WebkitTextFillColor: "transparent",
                        clipPath: clipPathStyle,
                    }}
                    className="text-[8vw] leading-[6.5vw] font-medium pl-[15%] p-2"
                >
                    {project.title}
                </motion.p>
            </div>
