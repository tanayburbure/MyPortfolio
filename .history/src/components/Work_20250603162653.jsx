...
function Title({ project, index, setSelectedProject }) {
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="pl-[15%] relative inline-block leading-[6.5vw] text-[8vw] font-medium">
          {/* Layer 1: Static Black Text */}
          <p className="text-[#2F2D29] p-2 pointer-events-none select-none">
            {project.title}
          </p>

          {/* Layer 2: Beige Scroll Reveal perfectly aligned */}
          <motion.p
            style={{ clipPath: clipPathStyle }}
            className="text-[#b7ab98] p-2 absolute top-0 left-0 pointer-events-none select-none"
          >
            {project.title}
          </motion.p>
        </div>
  ...
  return (
    <div className="absolute top-0 h-full w-full z-2 pointer-events-none">
      {projects.map((project, index) => (
        ...
        >
          <p className="text-[#010101] mb-[0.6vh] uppercase font-semibold text-[8vw] leading-[7.1vw] px-[15.5%] relative z-1">
