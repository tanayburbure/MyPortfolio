...
const Client = () => {
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div className="absolute left-0 mt-[30vh] lg:mt-[50vh] w-full h-full z-0">
        <Earth />
      </div>

      {/* Content Above Earth (z-10) */}
      <div className="relative z-10 pt-32 lg:pt-56 px-6 lg:pl-[31vh] flex flex-col justify-center">
        <h5 className="mb-4 lg:mb-8 font-semibold shadow-lg text-sm lg:text-base tracking-widest">C L I E N T S</h5>
        <AnimatedText className="text-4xl lg:text-[9vh] cursor-expand mb-12 lg:mb-20 tracking-tight w-full lg:w-[80%] font-semibold leading-[1.2vw] lg:leading-[4.3vw]">
      ...
      <div className="relative z-10 top-[10vh] lg:top-[17vh] px-6 lg:px-0">
