  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full absolute top-[28%]">
          <h3 className="tracking-tight text-lg font-bold text-center mb-20 mr-6 font-[font11]">
            T A N A Y &nbsp;&nbsp; B U R B U R E
          </h3>

          <h1 className="text-center text-[16vh] font-bold leading-[6.4vw] tracking-tighter cursor-expand">
            STILL&nbsp;
