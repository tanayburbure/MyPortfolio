    ...
    return (
        <div className="relative">
            <div
                ...
                ref={containerRef}
            >
                <div className="inline-block pl-[1vw] md:pl-[15vw] lg:pl-[31vh] relative">
                    <p
                        className="text-[#2F2D29] font-thin text-[6vh] md:text-[8.2vw] leading-[8vh] md:leading-[6.5vw] cursor-pointer"
                    ...
                    <motion.p
                        style={{ clipPath: clipPathStyle }}
                        className="absolute top-0 left-[8vw] md:left-[15.6vw] text-[#b7ab98] font-thin text-[9vh] md:text-[8.2vw] leading-[8vh] md:leading-[6.5vw] pointer-events-none"
                    >
                        {project.title}
                    </motion.p>
                </div>
