...
function Motto() {
  return (
    <div className="h-[100vh]  relative overflow-hidden">
      ...
      <div className="absolute top-0 w-full h-[20vh] bg-gradient-to-b from-black/90 via-black/50 to-transparent z-10" />


      <div className="absolute bottom-0 w-full h-[20vh] bg-gradient-to-t from-black/90 via-black/50 to-transparent z-10" />
