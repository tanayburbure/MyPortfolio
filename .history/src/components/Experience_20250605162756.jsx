...
function Experience() {
  ...
  return (
    ...
    >
      {/* Gradient Shadow Top */}
      <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-b from-[#0D0D0D]/70 to-transparent z-10 pointer-events-none" />

      {/* Gradient Shadow Bottom */}
      <div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-[#0D0D0D]/70 to-transparent z-10 pointer-events-none" />
