...
export default function MaskedCursor() {
  ...
  return (
    <>
      {/* Black text copy underneath */}
      <div className="fixed inset-0 z-[9997] pointer-events-none select-none text-black opacity-100 mix-blend-normal">
        <div className="w-full h-full" id="text-layer">
          {/* Mirror your actual content here */}
          <YourTextMirrorComponent />
        </div>
      </div>

      {/* Masked orange layer that reveals black text */}
      <motion.div
