...
function Motto() {
  return (
    <div className='h-[100vh] relative overflow-hidden'>
      <img
        className=" object-cover backdrop-brightness-[20%] position-bottom absolute top-0 left-0 -z-10"
      ...
      <div className='top-[28%] left-0 right-0 absolute flex flex-col items-center text-center px-4'>
        <h5 className='text-sm mb-12'>M Y &nbsp; M O T T O</h5>
        <h2 className='text-[18vh] w-[60%] font-semibold tracking-tighter leading-[7vw]'>
          GOOD DESIGN IS HONEST
        </h2>
        <h4 className='mt-6'>Dieter Rams</h4>
      </div>
    </div>
  );
}
