    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center text-center">
        ...
        <div className="overflow-hidden mb-1 w-full max-w-[95vw] sm:max-w-[90vw]">
          <h1
  ref={mainHeadingRef}
  className="font-[font13] text-[#EB5939] text-[7.4vh] md:text-[12vh] lg:text-[9vw] leading-[6vh] tracking-tight cursor-expand"
>
  ...
  DEBUGGING
        ...
        {/* Animated Subtitle */}
        <div className="overflow-hidden mt-4 w-full max-w-[90vw]">
          <h1
            ref={subtitleRef}
