...
function Loader() {
  return (
    <div className='bg-[#0D0D0D] h-[100vh] relative w-full flex items-center justify-center'>
      <motion.div
        initial={{ opacity: 0, strokeDasharray: "0 100", strokeDashoffset: "100" }}
        animate={{ opacity: 1, strokeDasharray: "100 100", strokeDashoffset: "0" }}
        transition={{ duration: 2, ease: 'linear' }}
        className='h-[14vw] w-[14vw] border-[1.7px] border-[#b7ab98] rounded-full border-t-transparent'
        style={{
          borderStyle: 'solid',
          borderImage: 'conic-gradient(#b7ab98 0%, transparent 100%) 1',
          maskImage: 'radial-gradient(circle, rgba(0,0,0,1) 60%, rgba(0,0,0,0) 61%)',
        }}
      ></motion.div>
      <img
