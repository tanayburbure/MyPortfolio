    ...
    <div style={styles.container}>
      ...
      <style>
        {`
          @keyframes drawAndErase {
            0% {
              stroke-dashoffset: 188.5; /* Start fully un-drawn */
            }
            50% {
              stroke-dashoffset: 0; /* Fully drawn */
            }
            100% {
              stroke-dashoffset: 188.5; /* Erase from the same point it started (top) */
            }
          }

          .circle {
            animation: drawAndErase 6s ease-in-out forwards;
            transform: rotate(-90deg); /* Draw from top */
      ...
      <svg style={styles.svg} viewBox="0 0 64 64">
        <circle
          ...
          strokeDashoffset="188.5" /* Start fully un-drawn */
        />
      </svg>
    </div>
  );
