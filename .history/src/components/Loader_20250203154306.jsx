...
function Loader() {
  ...
  return (
    <div className={`h-screen flex items-center justify-center relative transition-opacity duration-1000 ease-in-out ${hideLoader ? 'opacity-0' : 'opacity-100'}`}>
      ...
      <button
        ...
        } hover:bg-[#AA9E8B] hover:text-[#0D0D0D] text-[2vh] absolute top-[55.5vh] px-12 py-[8px] pb-2 rounded-full border-[#b7ab98] text-[#b7ab98] transition-all duration-500 ease-in-out`}
        aria-label="Start"
