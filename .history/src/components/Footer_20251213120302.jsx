...
function Footer() {
  return (
    <div className="relative h-auto min-h-[50vh] flex flex-col w-full">
      <div className="pl-[5vw] sm:pl-[10vw] md:pl-[15vw] lg:pl-[32vh] pt-[8vh] sm:pt-[10vh] lg:pt-[15vh] px-4 sm:px-8 md:px-12 lg:px-48">
        <h3 className="text-sm sm:text-md lg:text-lg font-semibold shadow-lg font-[font14] tracking-widest mb-12 sm:mb-8 md:mb-10 lg:mb-12 ml-2">
          C O N N E C T
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 no-mask font-[font8]">
          ...
          <ul className="text-[2.5vh] sm:text-[3vh] md:text-[3.2vh] lg:text-[3.5vh]">
            <li className="flex items-center mb-1 sm:mb-5 md:mb-6 lg:mb-1">
          ...
          <ul className="text-[2.5vh] sm:text-[3vh] md:text-[3.2vh] lg:text-[3.5vh]">
            ...
            <li className="flex items-center mb-6 sm:mb-5 md:mb-6 lg:mb-1">
              <i className="ri-send-plane-2-fill text-[#EB5939] text-[1.8vh] sm:text-[2vh] md:text-[2.2vh] lg:text-[2.5vh]"></i>
              <HoverAnimation>
                <a
          ...
          <ul className="pt-1 md:pt-0 lg:pt-1">
            <li className="flex items-center mb-2 sm:mb-5 md:mb-6 lg:mb-4 text-[2vh] sm:text-[2.3vh] md:text-[2.5vh] lg:text-[2.7vh]">
