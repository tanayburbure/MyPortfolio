...
function Footer() {
  return (
    <div className="h-auto min-h-[50vh] flex flex-col w-full">
      <div className="pl-[5vw] sm:pl-[10vw] md:pl-[15vw] lg:pl-[32vh] pt-[11vh] sm:pt-[10vh] lg:pt-[15vh] px-4 sm:px-8 md:px-12 lg:px-48">
        <h3 className="text-sm sm:text-md font-semibold shadow-lg font-[font14] tracking-widest mb-8 sm:mb-8 md:mb-10 lg:mb-12 ml-2">C O N N E C T</h3>
