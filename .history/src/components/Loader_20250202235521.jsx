    ...
    <div style={styles.container}>
      ...
      <style>
        {`
          @keyframes drawAndDisappear {
            0% {
              stroke-dashoffset: 188.5; /* Circle starts fully "un-drawn" */
            }
            50% {
              stroke-dashoffset: 0; /* Circle is fully drawn */
            }
            100% {
              stroke-dashoffset: 188.5; /* Circle starts disappearing from the top */
            }
          }
      ...
      <svg style={styles.svg} viewBox="0 0 64 64">
        <circle
          ...
          strokeDashoffset="188.5" /* Circle starts fully "un-drawn" */
        />
      </svg>
    </div>
  );
