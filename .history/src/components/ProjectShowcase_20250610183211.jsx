    ...
    return (
        <div className="absolute top-[-3vh] mt-[3.05vh] w-screen z-2 pointer-events-none">
            {projects.map((project, index) => (
                <div
                    key={index}
                    className="bg-[#ec4e39] h-[7.6vh] md:h-[6vw] pt-2 text-[#0D0D0D] font-thin flex flex-col md:flex-row justify-between items-center px-[5%] md:px-[15%] transition-all duration-500 ease-in-out"
                    style={{
                        clipPath: selectedProject === index ? "inset(0 0 0)" : "inset(50% 0 50%)",
                    }}
                >
