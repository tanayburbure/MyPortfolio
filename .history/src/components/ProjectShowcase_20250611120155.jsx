        ...
        <div className="relative">
            ...
            >
                <div className="inline-block md:pl-[1vw] lg:pl-[15.4%] relative">
                    ...
                    <motion.p
                        style={{ clipPath: clipPathStyle }}
                        className="absolute top-0 sm:left-[12vw] md:left-[1vw] lg:left-[15.4%] text-[#b7ab98] font-thin text-[6vh] sm:text-[5.5vw] md:text-[6vw] lg:text-[8.2vw] leading-[6.5vh] sm:leading-[5.5vw] md:leading-[5.8vw] lg:leading-[6.5vw] pointer-events-none"
                    >
                        {project.title}
                    </motion.p>
                </div>
