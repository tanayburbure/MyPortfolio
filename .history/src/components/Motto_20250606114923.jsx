...
function Motto() {
  ...
  return (
    ...
    >
      {/* Top smoky gradient */}
      <div className="absolute top-0 left-0 w-full h-[10vh] bg-gradient-to-b from-[#0D0D0D] to-transparent z-0" />

      {/* Bottom smoky gradient */}
      <div className="absolute bottom-0 left-0 w-full h-[10vh] bg-gradient-to-t from-[#0D0D0D] to-transparent z-0" />
