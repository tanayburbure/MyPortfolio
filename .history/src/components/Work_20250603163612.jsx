        ...
        <div className="relative">
            ...
            >
                <div className="inline-block pl-[15%] relative">
                    <p className="text-[#2F2D29] p-2 font-medium text-[8vw] leading-[6.5vw]">
                        {project.title}
                    </p>
                    
                    <motion.p
                        style={{ clipPath: clipPathStyle }}
                        className="absolute top-0 left-[14.8vw] text-[#b7ab98] p-2 font-medium text-[8vw] leading-[6.5vw]"
                    >
                        {project.title}
                    </motion.p>
                </div>
    ...
    return (
        <div className="absolute top-0 h-full w-full z-2 pointer-events-none">
            {projects.map((project, index) => (
                ...
                >
                    <p className="text-[#010101] absolute top-0 left-[14.8vw] p-2 font-medium text-[8vw] leading-[6.5vw] z-1">
