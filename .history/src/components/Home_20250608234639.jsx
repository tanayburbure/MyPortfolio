  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full absolute top-[28%]">
          ...
          <h1 className="text-center text-[17vh] font-regular leading-[6.4vw] tracking-tight cursor-expand font-[font13]">
            STILL&nbsp;
            <span className="text-[#EB5939] ">DEBUGGING <br /></span>
          </h1>
          <h3 className='text-center mt-2 text-[6.5vh] tracking-tight font-semibold cursor-expand font-[font9]'>SINCE 2023</h3>
      </div>
    </div>
  );
}
