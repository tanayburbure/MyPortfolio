...
function About() {
  return (
    <div className='h-screen pl-[31vh] pb-4 flex flex-col justify-center'>
      <h5 className='text-sm font-semibold mb-8 font-[font14] tracking-widest'>A B O U T &nbsp; M E</h5>

      <AnimatedText className="text-[8vh] font-[font9] tracking-tighter w-[77%] font-semibold leading-[4.3vw] cursor-expand">
