...
export default function MaskedCursor() {
  ...
  return (
    <>
      {/* **Black Text Layer (Only visible in mask) */}
      <motion.div
        className="pointer-events-none fixed inset-0 z-[9999]"
        style={{
          WebkitMaskImage: "url('images/mask.svg')",
          WebkitMaskRepeat: 'no-repeat',
          backgroundColor: 'black', // Makes text black in the mask
          mixBlendMode: 'screen', // Ensures only text is affected
        }}
        animate={{
      ...
      <motion.div
        ...
        style={{
          WebkitMaskImage: "url('images/mask.svg')",
          WebkitMaskRepeat: 'no-repeat',
          backgroundColor: '#ec4e39', // Your original color
        }}
        animate={{
          WebkitMaskPosition: `${x - size / 2}px ${y - size / 2}px`,
          WebkitMaskSize: `${size}px`,
